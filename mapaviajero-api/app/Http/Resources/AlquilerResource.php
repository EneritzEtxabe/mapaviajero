 ...
 *              type="object",
 *              @OA\Property(property="id", type="integer", example=3),
 *              @OA\Property(property="nombre", type="string", example="SUV")
 *         ),
    ...
    public function toArray(Request $request): array
    {
        ...
        $resultado =[
            ...
            'coche'=>[
                'id' => $this->coche->id,
                'marca' =>[
                    'id'=>$this->coche->marca->id,
                    'nombre'=>$this->coche->marca->nombre
                ],
                'carroceria' =>[
                    'id'=>$this->coche->carroceria->id,
                    'nombre'=>$this->coche->carroceria->nombre
                ],
                'ano'=>$this->coche->ano,
                ...
                'pais' =>[
                    'id'=>$this->coche->pais->id,
                    'nombre'=>$this->coche->pais->nombre
                ],
            ],
            'cliente' =>[
                'id'=>$this->cliente->id,
