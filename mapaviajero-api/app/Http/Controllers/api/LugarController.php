...
class LugarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        [
            ...
            'localizacion_url' => 'nullable|regex:/^https?:\/\/.+$/i',
        ...
        [
            ...
            'localizacion_url.regex' => 'La URL de localización no tiene un formato válido.',
    ...
    public function update(Request $request, string $id)
    {
        ...
        $data = $request->validate(
            [
                'nombre' => 'sometimes|string|unique:lugares,nombre,'.$lugar->id.'|max:255',
