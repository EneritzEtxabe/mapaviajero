<template>
  <Loader :loading="loading" :error="error">
    <template v-if="lugar">
      <ImagenCabecera :imagen="lugar.imagen_url" alt="Imagen del lugar" :texto="lugar.nombre" />
      <div class="max-w-6xl mx-auto p-6">
        ...
        <div class="flex flex-col md:flex-row items-center md:items-center gap-2">
          ...
          <div class="w-full md:w-2/3 p-4 rounded">
            ...
            <p class="text-gray-700 mb-2"><strong>Descripción:</strong> {{ lugar.descripcion }}</p>
        ...
        <h2
          v-if="lugar.localizacion_url"
          class="text-3xl sm:text-4xl font-bold mt-15 text-center f-color--dark tracking-wide"
        >
