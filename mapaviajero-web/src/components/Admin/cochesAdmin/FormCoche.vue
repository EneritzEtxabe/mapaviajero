    ...
    <div class="max-w-xl mx-auto p-4">
      ...
      <form @submit.prevent>
        ...
        <div class="mb-4">
          ...
          <select v-model="form.marca_id" class="w-full border px-3 py-2 rounded" :class="{ 'border-red-500': v.marca_id.hayError }">
        ...
        <div class="mb-4">
          ...
          <select v-model="form.carroceria_id" class="w-full border px-3 py-2 rounded" :class="{ 'border-red-500': v.carroceria_id.hayError }">
        ...
        <div class="mb-4">
          ...
          <select v-model="form.nPlazas" class="w-full border px-3 py-2 rounded" :class="{ 'border-red-500': v.nPlazas.hayError }">
        ...
        <div class="mb-4">
          ...
          <select v-model="form.cambio" class="w-full border px-3 py-2 rounded" :class="{ 'border-red-500': v.cambio.hayError }">
        ...
        <div class="mb-4">
          ...
          <select v-model="form.estado" class="w-full border px-3 py-2 rounded" :class="{ 'border-red-500': v.estado.hayError }">
